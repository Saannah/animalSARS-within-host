...
if(file.size(vcf_filename) == 0){
  ...
  write.table(out, file = paste0(dir, SRA_id, "_pNpS_corrected.tsv"), sep = "\t", row.names = FALSE)
  print("file written")
  stop("file empty")
}
...
start = c(266, 13468, 21563, 25393, 25814, 25524,26245, 26523, 27202, 27394, 27756,27894, 28274, 28734, 29558)
end = c(13468, 21555, 25384, 26220, 25882, 25697, 26472, 27191, 27387, 27759, 27887,28259, 29533, 28955, 29674)
name = c("orf1a", "orf1b", "S","ORF3a","ORF3b","ORF3c","E","M","ORF6","ORF7a", "ORF7b","ORF8", "N", "ORF9c","ORF10")
